	...
	integrations: [
		...
		robots({
			policy: [
				{
					userAgent: ["*"],
					disallow: ["/*.doc", "*/?from=*", "*/compare/?*"],
					allow: ["*.css", "*.js", "*.jpg", "*.png", "*.svg", "*.gif", "/assets/snippets/*.css", "/assets/snippets/*.js"],
				},
				{
					userAgent: "Yandex",
					cleanParam: ["utm_source"],
					disallow: ["*/compare/?*", "*/?from=*", "/*.doc"],
					allow: ["*.css", "*.js", "*.jpg", "*.png", "*.svg", "*.gif"],
				},
				{
					userAgent: "Googlebot",
					disallow: ["*/?from=*", "/*.doc", "*/compare/?*"],
					allow: ["*.css", "*.js", "*.jpg", "*.png", "*.svg", "*.gif"],
				},
			],
		}),
